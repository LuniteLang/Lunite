...
#[no_mangle] pub extern "C" fn lunite_str_len_runtime(s: *const LuniteString) -> i64 { if s.is_null() { 0 } else { unsafe { (*s).len as i64 } } }
#[no_mangle] pub extern "C" fn lunite_str_at(s: *const LuniteString, i: i64) -> i64 { if s.is_null() || i < 0 || i as usize >= unsafe { (*s).len } { -1 } else { unsafe { *(*s).ptr.add(i as usize) as i64 } } }
...
#[no_mangle] pub extern "C" fn lunite_realloc(p: *mut u8, os: i64, ns: i64) -> *mut u8 { 
    if ns <= 0 { lunite_release(p); return ptr::null_mut(); }
    if p.is_null() { return lunite_alloc(ns as usize, ptr::null_mut(), ptr::null_mut()); }
    let np = lunite_alloc(ns as usize, ptr::null_mut(), ptr::null_mut());
    unsafe { ptr::copy_nonoverlapping(p, np, std::cmp::min(os as usize, ns as usize)); }
    lunite_release(p);
    np
}
#[no_mangle] pub extern "C" fn lunite_arena_save() -> i64 { 0 }
#[no_mangle] pub extern "C" fn lunite_arena_restore(_: i64) {}
#[no_mangle] pub extern "C" fn lunite_throw(_: *const i8) {}
#[no_mangle] pub extern "C" fn lunite_sys_system(_: *const LuniteString) -> i64 { 0 }
#[no_mangle] pub extern "C" fn lunite_str_eq(s1: *const LuniteString, s2: *const LuniteString) -> i64 {
    if s1 == s2 { return 1; }
    if s1.is_null() || s2.is_null() { return 0; }
    unsafe {
        if (*s1).len != (*s2).len { return 0; }
        if std::slice::from_raw_parts((*s1).ptr, (*s1).len) == std::slice::from_raw_parts((*s2).ptr, (*s2).len) { 1 } else { 0 }
    }
}
#[no_mangle] pub extern "C" fn lunite_str_substring(s: *const LuniteString, start: i64, end: i64) -> *mut LuniteString {
...
#[no_mangle] pub extern "C" fn lunite_net_bind(port: i64) -> LuniteResult { LuniteResult { tag: 1, payload: 0 } }
#[no_mangle] pub extern "C" fn lunite_net_accept(_: *mut TcpListener) -> LuniteResult { LuniteResult { tag: 1, payload: 0 } }
#[no_mangle] pub extern "C" fn lunite_net_read(_: *mut TcpStream) -> LuniteResult { LuniteResult { tag: 1, payload: 0 } }
#[no_mangle] pub extern "C" fn lunite_net_write(_: *mut TcpStream, _: *const LuniteString) {}
#[no_mangle] pub extern "C" fn lunite_net_close_socket(_: *mut TcpStream) {}
#[no_mangle] pub extern "C" fn lunite_net_close_server(_: *mut TcpListener) {}
#[no_mangle] pub extern "C" fn lunite_channel_create() -> *mut u8 { ptr::null_mut() }
#[no_mangle] pub extern "C" fn lunite_channel_send(_: *mut u8, _: i64) {}
#[no_mangle] pub extern "C" fn lunite_channel_recv(_: *mut u8) -> i64 { 0 }
#[no_mangle] pub extern "C" fn lunite_spawn(_: extern "C" fn(*mut u8), _: *mut u8) {}
#[no_mangle] pub extern "C" fn lunite_time_now() -> i64 { 0 }
#[no_mangle] pub extern "C" fn lunite_time_sleep(_: i64) {}
#[no_mangle] pub extern "C" fn lunite_srand(_: i64) {}
#[no_mangle] pub extern "C" fn lunite_rand_int() -> i64 { 0 }
#[no_mangle] pub extern "C" fn lunite_array_copy(src: *mut u8, dst: *mut u8, count: i64, elem_size: i64) {
